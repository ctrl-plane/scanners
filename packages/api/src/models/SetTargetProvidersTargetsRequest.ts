 ...
 */
export function instanceOfSetTargetProvidersTargetsRequest(value: object): value is SetTargetProvidersTargetsRequest {
    if (!('targets' in value) || value['targets'] === undefined) return false;
    return true;
}

export function SetTargetProvidersTargetsRequestFromJSON(json: any): SetTargetProvidersTargetsRequest {
    return SetTargetProvidersTargetsRequestFromJSONTyped(json, false);
}

export function SetTargetProvidersTargetsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SetTargetProvidersTargetsRequest {
    if (json == null) {
        return json;
    }
    return {
        
        'targets': ((json['targets'] as Array<any>).map(SetTargetProvidersTargetsRequestTargetsInnerFromJSON)),
    };
}

export function SetTargetProvidersTargetsRequestToJSON(value?: SetTargetProvidersTargetsRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'targets': ((value['targets'] as Array<any>).map(SetTargetProvidersTargetsRequestTargetsInnerToJSON)),
    };
}
