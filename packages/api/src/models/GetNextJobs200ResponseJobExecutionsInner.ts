...
export function GetNextJobs200ResponseJobExecutionsInnerFromJSON(json: any): GetNextJobs200ResponseJobExecutionsInner {
    return GetNextJobs200ResponseJobExecutionsInnerFromJSONTyped(json, false);
}

export function GetNextJobs200ResponseJobExecutionsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetNextJobs200ResponseJobExecutionsInner {
    if (json == null) {
        return json;
    }
    return {
...
export function GetNextJobs200ResponseJobExecutionsInnerToJSON(value?: GetNextJobs200ResponseJobExecutionsInner | null): any {
    if (value == null) {
        return value;
    }
    return {
